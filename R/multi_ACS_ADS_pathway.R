...
##' @title Resemblance analysis for multiple pairs: pathway-specific ACS, ADS and their permuted p-value
...
##' @return Four lists: pathway-specific ACS values and its permuted p-value. 
